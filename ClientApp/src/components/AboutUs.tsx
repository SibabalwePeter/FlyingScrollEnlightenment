...
class AboutUs extends React.PureComponent {
    public render() {
        return (
            ...
            <Row>
              <Col><h5>Career Development Programme</h5>
                <p>
              ...
              <Col><h5>Education System Programme</h5>
                <p>
              ...
              <Col><h5>Youth Development Programme</h5>
                <p>
              ...
              <Col><h5>Flying Scroll Enlightenment (Pty) Ltd Actuality</h5>
                <p>
